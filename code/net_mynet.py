...
class MedRepLearn(nn.Module):
    ...
    def forward(self,meds):
        ...
        # masks代表病人历史用过的所有药物，据此计算历史用药和新用药的 embedding table
        ...
        # 通过PiecewiseTSL初步预测下一次用药中的历史用药和新用药表示
        # [batch, 2k, emb_dim]
...
class MyNet(nn.Module):
    def __init__(self, emb_dim, voc_size,k,ehr_adj,ddi_adj):
        ...
        self.w=nn.Parameter(torch.ones(self.m_voc_size))
